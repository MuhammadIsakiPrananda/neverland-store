        ...
        <div key={index} className="bg-slate-800/50 border border-slate-700/50 rounded-xl overflow-hidden">
          <div className="p-4 bg-slate-800/50">
            <div className="flex items-center space-x-3">
              <div className="text-sky-400">{method.icon}</div>
  ...
  return (
    <div className="fixed inset-0 bg-black/90 backdrop-blur-md z-50 flex items-center justify-center p-4 animate-fade-in custom-scrollbar">
      <div className="bg-gradient-to-br from-slate-900 to-slate-950 border border-slate-700/50 rounded-3xl max-w-5xl w-full max-h-[90vh] shadow-2xl shadow-sky-900/20 flex flex-col">
        ...
        {/* Footer */}
        <div className="p-6 border-t border-slate-700/50 bg-gradient-to-r from-slate-900/50 to-slate-800/50 flex-shrink-0">
          <div className="flex items-center justify-between">
            {step > 1 && (
              <button
                onClick={handleBack}
                className="flex items-center space-x-2 px-6 py-3 bg-slate-800/50 border border-slate-700/50 hover:bg-slate-800 rounded-xl font-semibold transition-all"
              >
