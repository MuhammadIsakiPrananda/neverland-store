...
const Footer = () => {
  ...
  return (
    <footer id="contact" className="relative bg-slate-950 border-t border-slate-800/50 overflow-hidden">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div>
              ...
              <div className="flex flex-wrap items-center justify-center md:justify-end gap-2">
                ...
                {/* GoPay */}
                <div className="bg-slate-800/50 border border-slate-700/50 px-3 py-2 rounded-lg text-xs font-medium text-slate-300 flex items-center gap-2">
      ...
      <div className="h-1 bg-gradient-to-r from-transparent via-sky-500 to-transparent" />
    </footer>
  );
};
