...
export default function Navbar({ onCategoryChange }) {
  ...
  return (
    <nav className="bg-slate-900/80 backdrop-blur-xl sticky top-2 z-50 mx-auto w-full max-w-4xl rounded-full border border-slate-700/50 shadow-lg shadow-indigo-900/20 my-2 px-2 outline outline-2 outline-indigo-500/30 md:outline-none">
