...
const Newsletter = () => {
  ...
  return (
    <div className="py-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden bg-dark-900/40">
      {/* Animated Background */}
      <div className="absolute inset-0 -z-10">
        <div className="absolute inset-0 bg-gradient-to-r from-primary-600/15 via-accent-purple/15 to-accent-pink/15" />
      </div>
      
      {/* Floating Elements */}
      <div className="absolute inset-0 -z-10 overflow-hidden">
        <div className="absolute top-20 left-10 w-20 h-20 bg-primary-500/25 rounded-full blur-2xl animate-float" />
        <div className="absolute bottom-20 right-10 w-32 h-32 bg-accent-purple/25 rounded-full blur-2xl animate-float-delayed" />
        <div className="absolute top-1/2 left-1/4 w-24 h-24 bg-accent-pink/25 rounded-full blur-2xl animate-float" style={{ animationDelay: '1s' }} />
      </div>
          ...
          <div className="relative z-10">
            ...
            <div className="inline-flex items-center justify-center mb-6 animate-bounce-slow">
              <div className="relative">
                <div className="absolute inset-0 bg-gradient-to-r from-primary-500 to-accent-purple rounded-full blur-xl animate-pulse" />
                <div className="relative bg-gradient-to-r from-primary-500 to-accent-purple p-4 rounded-2xl">
            ...
            <p className="text-slate-300 text-lg mb-8 max-w-2xl mx-auto animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
            ...
            {!isSubscribed ? (
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <div className="relative flex-1">
                    ...
                    <input
                      ...
                      required
                      className="w-full pl-12 pr-4 py-4 bg-dark-900/50 border border-slate-700 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:border-primary-500 focus:ring-2 focus:ring-primary-500/20 transition-all"
                    />
                  </div>
                  <button
                    type="submit"
                    disabled={isLoading}
                    className="btn-neon whitespace-nowrap flex items-center justify-center space-x-2 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    {isLoading ? (
                      <>
              ...
              <div className="max-w-md mx-auto animate-fade-in-up">
                <div className="flex items-center justify-center space-x-3 glass-card px-6 py-4 rounded-xl border-2 border-green-500/50">
